...
export default async function LesionPage({
  ...
  const avg =
    total > 0 ? ascSessions.reduce((a, s) => a + s.pain_level, 0) / total : 0;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        <Link
          href="/dashboard"
          className="p-3 -ml-3 rounded-xl active:scale-90 transition-transform flex items-center justify-center shrink-0"
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2.5">
            ...
            />
            <h1
              className="text-[28px] font-bold tracking-tight truncate"
          ...
          {lesion.zone && (
            <p className="text-[14px] ml-5" style={{ color: "var(--text2)" }}>
              {lesion.zone}
            </p>
          )}
        </div>
        <div className="flex items-center gap-2 shrink-0">
          ...
          <SessionForm
            lesionId={lesion.id}
            userId={user.id}
            defaultPainLevel={last?.pain_level ?? 5}
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          {
            label: "Último",
            value: last ? last.pain_level : "–",
            color: last ? painColor(last.pain_level) : "var(--text2)",
          },
          {
            label: "Promedio",
      ...
      >
        ...
        <p className="text-[13px] mb-1" style={{ color: "var(--text2)" }}>
          {chartData.length > 0
            ? `Últimas ${Math.min(chartData.length, 15)} sesiones`
            : "Sin datos"}
        </p>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <span
            className="text-[12px] font-semibold px-2.5 py-1 rounded-full tabular-nums"
            style={{
        ...
        {history.length === 0 ? (
          <div
            ...
            style={{ border: "1.5px dashed var(--divider)" }}
          >
            <Activity
            ...
            <p
              ...
              style={{ color: "var(--text2)", opacity: 0.6 }}
            >
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <div className="min-w-0 flex-1">
                        ...
                        >
                          ...
                          <span
                            className="mx-1.5"
                            style={{ color: "var(--text2)", opacity: 0.3 }}
                          >
                            ·
                          </span>
                          <BrowserDateTime
                      ...
                      <div
                        className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-[14px] font-bold tabular-nums shrink-0"
                        style={{
                          background: `color-mix(in srgb, ${pc} 12%, transparent)`,
                          color: pc,
                        }}
                      >
                        ...
                        {s.exercises && (
                          <div className="flex gap-2">
                            <Dumbbell
                              ...
                              style={{ color: "var(--text2)", opacity: 0.4 }}
                            />
                            <p
